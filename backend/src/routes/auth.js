...
router.get('/google/callback',
    (req, res, next) => {
        ...
        passport.authenticate('google', { 
            failureRedirect: 'https://calendar-dashboard-wb-git-master-om-dixits-projects.vercel.app/login?error=auth_failed',
            session: true 
        })(req, res, next);
    },
    (req, res) => {
        ...
        res.redirect('https://calendar-dashboard-wb-git-master-om-dixits-projects.vercel.app/auth/callback');
    }
);
...
router.post('/refresh-token', isAuthenticated, async (req, res) => {
    try {
        ...
        const oauth2Client = new google.auth.OAuth2(
            ...
            'https://calendar-dashboard-wb-git-master-om-dixits-projects.vercel.app/auth/callback'
        );
...
router.get('/logout', (req, res) => {
    ...
    req.logout((err) => {
        ...
        req.session.destroy((err) => {
            ...
            res.redirect('https://calendar-dashboard-wb-git-master-om-dixits-projects.vercel.app/login');
        });
    });
});
